  ...
  switch (req.method) {
    ...
    case 'PUT':
      try {
        ...
        await User.updateOne({email: email}, {$set: {"address.country": country, "address.region": region, "address.city": city, "address.streetAddressLine1": streetAddressLine1, "address.streetAddressLine2": streetAddressLine2}}) 
    ...
    case 'GET':
      try {
        ...
        const user = await User.findOne({email: email}, {address: 1, email: 1}).lean().exec();
