...
//   const elementRef = useRef();
  ...
  const modalContent = show ? (
    <div className={moduleCss.styledModalOverlay}>
      ...
      <a href="#" onClick={handleCloseClick} className={moduleCss.styledModalHeader }>
        x
      </a>
      <div>Title: <span className={moduleCss.StyledModalTitle}>{title}</span></div>
      <div className={moduleCss.styledModalBody}>{children}</div>
      </div>
    </div>
  ) : null;
